...
> [Invite link](https://bot.kotlin.no)
<br/>[Server Link](https://discord.kotlin.no)
<br/>`rufus#0001`

A multipurpose open-source [Discord](https://discordapp.com/) bot made with discord.py
...
- `Disclaimer:` All bot-PMs, commands, mentions and errors will be logged, the logfile is cleared regularly and is only read if the bot is running into problems and for debugging purposes.
...
## n-FaQ
- Why does Rufus ask for so many permissions?
	- These are the permissions Rufus needs in order to show his full potential. You are free to remove certain permission as you please, note that this might restrict certain commands.
- Why "Rufus"?
	- I didn't have a name I liked when creating the bot, and chose Rufus as a placeholder name. I ended up sticking with the name.
- Do you have status updates?
	- Sure do! [Join](https://discord.kotlin.no) the Discord server for travis-ci and git updates.
