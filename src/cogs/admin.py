...
class Admin:
    ...
    async def inviter(self, ctx):
        welcomeChannel: discord.Channel.name = 'welcome'
        invitelinknew = await self.bot.create_invite(destination = discord.Channel(welcomeChannel), xkcd = True, max_uses = 100)
